...
import {LayoutGrid, Atom, Network, Microscope, MessageSquareText,Settings, ChevronLeft, SidebarOpen} from "lucide-react"
        ...
        >
          ...
          <Link href="/">
            <div className="flex flex-row items-center justify-center space-x-2">
              ...
              <p className="text-xl font-semibold text-white">DrugX</p>
            </div>
          </Link>
